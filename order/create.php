...
if (isset($_POST['btn'])) {
    ...
    $create = "INSERT INTO orders  VALUES (null,'$amount','$customer_id','$product_id','$date')";
    mysqli_query($connect, $create);
    $_SESSION['message'] = "Order Created Successfuly!";

    header("location:/Task/order/create.php");
    exit();
}
                        ...
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="amount" class="form-control mb-3" id="" required>
                                </div>
